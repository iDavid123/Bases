        ...
        <div class="col-md-10 col-lg-5 mx-auto">
          <div class="card shadow-lg bg-white">
            <div class="card-header">
              <h2>Registre su Auto</h2>
            </div>
            <div class="card-body">
              <form v-on:submit.prevent="register()">
                <div class="form-group">
                  <input type="text" v-model="driver.marca"  class="form-control" required="required" placeholder="First Name">
                </div>
                <div class="form-group">
                  <input type="text" v-model="driver.modelo" class="form-control" placeholder="Last Name">
                </div>
                <div class="input-group form-group">
                  <div class="input-group-prepend">
                    <div class="input-group-text">+57</div>
                  </div>
                  <input type="number" v-model="driver.numsoat" class="form-control" id="inlineFormInputGroupUsername" placeholder="Phone">
                </div>
                <div class="form-group">
                  <input type="text" v-model="driver.placa" class="form-control" placeholder="Email">
                </div>
                <div class="form-group">
                  <input type="number" v-model="driver.anho" class="form-control" placeholder="Credit Card">
                </div>
